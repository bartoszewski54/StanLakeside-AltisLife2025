...
class AH_Authenticate
{
	...
	enableSimulation = true;
	 ...
	 class controlsBackground {
        ...
        {
            idc = 1101;
            text = "<t align='center' size='1.5'>Wymanga weryfikacja</t>";
        ...
        {
            idc = 1100;
            text = "<t align='center'>Witaj na StanLakeside!<br/>Z powodu ataków cheaterów wprowadziliśmy weryfikacje<br/>Aby się zweryfikować kliknij przycisk poniżej.</t>";
        ...
        {
            idc = 1102;
            text = "<t align='center' size='0.7'>Przycisk ZWERYFIKUJ, skopiuje link który musisz odpalic w przeglądarce.</t>";
            x = 7 * GUI_GRID_W + GUI_GRID_X;
    ...
    class controls {
        ...
        {
            idc = 1601;
            text = "Kliknij mnie po weryfikacji!";
            x = 7 * GUI_GRID_W + GUI_GRID_X;
            y = 14.2 * GUI_GRID_H + GUI_GRID_Y;
            w = 24 * GUI_GRID_W;
            h = 2 * GUI_GRID_H;
...
class AH_LagSwitch
{
	...
	class controls {
		...
		{
			idc = -1;
			text = "<t align='center' size='1.7'>SPRAWDŹ SWOJE POŁĄCZENIE Z INTERNETEM</t>";
		...
		{
			idc = -1;
			text = "JEŚLI TO PROBLEM Z SERWEREM ZGŁOŚ TO DO ADMINISTRACJI";
