...
class DialogMedical {
	...
	class Controls {
		...
		class Packing : FieldDressing {
			...
			tooltip = "Załóż bandaż uciskający";
		...
		class Elastic : FieldDressing {
			...
			tooltip = "Załóż elastyczny bandaż";
		...
		class Revive : Life_RscButtonCenter {
			idc = 4914;
			text = "<t align = 'center'>Reanimuj</t>";
