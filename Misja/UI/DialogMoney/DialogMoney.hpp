...
class DialogMoney {
	...
	class Controls {
		...
		class Personal : Life_RscStructuredText {
			idc = 4102;
			text = "<t align='left'>$1,000,000</t><t align='right'>1.5%</t><br/><t size='0.9'>Saldo<t align='right'>Podatek</t></t>";
			colorBackground[] = INNER_BODY_COLOUR;
			SAFEZONE_X(UI_X + MARGIN_X);
		...
		class Transfer : Life_RscButtonCenter {
			idc = 4108;
			text = "<t align = 'center'>Przelej</t>";
			onButtonClick = "[(findDisplay getNumber(configFile >> ""RscDisplayMission"" >> ""idd"")), [""Police"", ""Medic"", ""Hato"", ""Civilian""], [], { _this params [[""_display"", displayNull, [displayNull]]]; if (isNull _display) exitWith {}; private _list = _display displayCtrl 3809; private _unit = (_list tvData (tvCurSel _list)) call BIS_fnc_objectFromNetId; if (isNull _unit) exitWith { [""Nikogo nie wybrałeś!""] call fini_fnc_noty; }; [0.01, [_unit], { [_this select 0, true] call ULP_fnc_giveMoney }] call ULP_fnc_waitExecute; }, false, false] call ULP_fnc_selectPlayer;";
