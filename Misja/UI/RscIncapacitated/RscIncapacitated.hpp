	...
	onUnload = "_this call ULP_UI_fnc_RscIncapacitated_OnUnload";
     ...
     class Controls {
        ...
        class SubText : Life_RscStructuredText {
            idc = 9002;
            text = "<t align='left' size='1'>Oczekiwanie na respawn...</t><t align='right' size='1'>Najbliższy medyk: ##m</t>";
        ...
        class ProgressText : Life_RscStructuredText {
            idc = 9003;
            text = "<t align='center' size='1'>Wykrwawianie...</t>";
            x = 0.376251 * safezoneW + safezoneX;
        ...
        class RequestMedic : Life_RscStructuredText {
            idc = 9005;
            text = "<t align='center' size='1'>Naciśnij <t color='#8A2BE2'>Spacje</t> aby wezwać medyka</t>";
            x = 0.29375 * safezoneW + safezoneX;
