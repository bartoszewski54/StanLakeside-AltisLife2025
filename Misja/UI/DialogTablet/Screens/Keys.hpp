		...
		class NameOption : Life_RscControlsGroupNoScrollbars {
            ...
            class Controls {
                class OptionName: Life_RscText {
                    idc = 101;
                    text = "Zmień nazwę";
                    tooltip = "Możesz zmienić nazwę swojego domu, aby ułatwić jego znalezienie...";
                    w = (15.55 / 2) * GUI_GRID_CENTER_W;
                    h = SIZE_M * GUI_GRID_CENTER_H;
                };
                class OptionButton : ULP_RscButtonClean {
                    idc = 102;
                    text = "<t align = 'center'>Akceptuj</t>";
		...
		class ShareOption : Life_RscControlsGroupNoScrollbars {
			...
			class Controls {
				class OptionName: Life_RscText {
					idc = 101;
					text = "Współdziel dom";
					tooltip = "Możesz udostępnić dom członkom swojej grupy...";
					w = (15.55 / 2) * GUI_GRID_CENTER_W;
					h = SIZE_M * GUI_GRID_CENTER_H;
				};
				class OptionButton : ULP_RscButtonClean {
		...
		class ShareOption : Life_RscControlsGroupNoScrollbars {
			...
			class Controls {
				class OptionName: Life_RscText {
					idc = 101;
					text = "Rozdaj klucze";
					tooltip = "Daj klucz każdemu kto jest w pojeździe...";
					w = (15.55 / 2) * GUI_GRID_CENTER_W;
					h = SIZE_M * GUI_GRID_CENTER_H;
				};
				class OptionButton : ULP_RscButtonClean {
					idc = 102;
					text = "<t align = 'center'>Rozdaj</t>";
