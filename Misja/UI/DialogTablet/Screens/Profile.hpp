...
class PrestigeText : Life_RscStructuredText {
    idc = 23025;
    text = "<t size ='1' align='center'><t size ='1.25'>10</t><br/>Prestiż</t>";
...
class PrestigeButton : ULP_RscButtonIcon {
	...
	tooltip = "Naciśnięcie tego przycisku spowoduje nadanie prestiżu i usunięcie postępów.";
...
class LevelText : Life_RscStructuredText {
    idc = 23026;
    text = "<t size ='1' align='center'><t size ='1.25'>50</t><br/>Poziom</t>";
...
class RepText : Life_RscStructuredText {
    idc = 23027;
    text = "<t size ='1' align='center'><t size ='1.25'>2000</t><br/>Reputacja</t>";
...
class PreviewText : Life_RscStructuredText {
	idc = 23057;
	text = "<t align='center' color='#75ffffff'>Podgląd</t>";
