...
class ChangeRank : ULP_RscButtonClean {
	idc = 23067;
	text = "<t align = 'center'>Zmień Rangę</t>";
...
class TransferOwnership : ChangeRank {
	idc = 23079;
	text = "<t align = 'center'>Zmień właściciela</t>";
...
class LeaveGroup : ULP_RscButtonClean {
	idc = 23081;
	text = "<t align = 'center'>Opuść grupę</t>";
...
class DisbandGroup : LeaveGroup {
	idc = 23076;
	text = "<t align = 'center'>Usuń grupę</t>";
...
class ChangeTax : ULP_RscButtonClean {
	idc = 23087;
	text = "<t align = 'center'>Zmień podatek grupowy</t>";
