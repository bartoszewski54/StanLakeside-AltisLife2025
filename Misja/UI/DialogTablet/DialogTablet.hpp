...
class DialogTablet {
	...
	class Controls {
		...
		class Profile : ULP_RscButtonClean {
			idc = 23002;
			text = "<br/><br/><br/><img image='\a3\ui_f\data\GUI\Rsc\RscDisplayMain\menu_singleplayer_ca.paa' align='center' size='7' color='#808080'/><br/><t align = 'center'>Profil</t>";
		...
		class Inventory : ULP_RscButtonClean {
			idc = 23003;
			text = "<br/><img image='\a3\ui_f_curator\Data\RscCommon\RscAttributeInventory\filter_10_ca.paa' align='center' size='4' color='#808080'/><br/><t align = 'center'>Ekwipunek</t>";
		...
		class Messaging : ULP_RscButtonClean {
			idc = 23004;
			text = "<br/><img image='\a3\3den\data\Cfg3DEN\Comment\texture_ca.paa' align='center' size='4' color='#808080'/><br/><t align = 'center'>Wiadomości</t>";
		...
		class Group : ULP_RscButtonClean {
			idc = 23005;
			text = "<br/><img image='\a3\ui_f\data\GUI\Rsc\RscDisplayMain\menu_multiplayer_ca.paa' align='center' size='4' color='#808080'/><br/><t align = 'center'>Grupa</t>";
		...
		class Keys : ULP_RscButtonClean {
			idc = 23006;
			text = "<br/><img image='data\ui\keys.paa' align='center' size='4' color='#808080'/><br/><t align = 'center'>Klucze</t>";
		...
		class Dispute : ULP_RscButtonClean {
			idc = 23007;
			enabled = 0;
			text = "<br/><img image='data\ui\dispute.paa' align='center' size='4' color='#808080'/><br/><t align = 'center'>Strefy</t>";
		...
		class Market : ULP_RscButtonClean {
			idc = 23008;
			text = "<br/><img image='\a3\3den\data\Displays\Display3DEN\ToolBar\vert_ATL_ca.paa' align='center' size='4' color='#808080'/><br/><t align = 'center'>Giełda</t>";
		...
		class Goals : ULP_RscButtonClean {
			idc = 23009;
			text = "<br/><br/><img image='\a3\ui_f_curator\Data\CfgMPGameTypes\zsc_ca.paa' align='center' size='3' color='#808080'/><br/><t align = 'center'>Questy community</t>";
		...
		class Perks : ULP_RscButtonClean {
			idc = 23010;
			text = "<br/><br/><img image='\a3\ui_f_curator\Data\RscCommon\RscAttributePunishmentAnimation\PushupsLegs.paa' align='center' size='3' color='#808080'/><br/><t align = 'center'>Perki</t>";
		...
		class Settings : ULP_RscButtonClean {
			idc = 23011;
			text = "<br/><img image='\a3\ui_f\data\GUI\Rsc\RscDisplayMain\menu_options_ca.paa' align='center' size='4' color='#808080'/><br/><t align = 'center'>Ustawienia</t>";
