...
class Toxic_Bus_Menu {
    ...
    class controls {
		...
		{
			idc = 2400;
			text = "Wsiadam do busa"; //--- ToDo: Localize;
			onButtonClick = "[] spawn ULP_fnc_busStart";
