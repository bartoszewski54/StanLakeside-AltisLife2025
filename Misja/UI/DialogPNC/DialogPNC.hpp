...
class DialogPNC {
    ...
    class ControlsBackground {
		class Header : Life_RscStructuredText {
			...
			text = "Komputer Policyjny <t align='right'>KamilOS 1.42</t>";
			SAFEZONE_X(UI_X);
	...
	class Controls {
		...
		class Computer : Login {
			...
			class Controls {
				...
				class ClearCrime : Life_RscButtonCenter {
					idc = 108;
					text = "<t align = 'center'>Usuń przestępstwo</t>";
		...
		class IssueWarrant : Life_RscButtonCenter {
			idc = 4704;
			text = "<t align = 'center'>Wystaw nakaz</t>";
		...
		class ClearWarrants : IssueWarrant {
			idc = 4705;
			text = "<t align = 'center'>Usuń nakazy</t>";
