...
[
	...
	format ["Napewno chcesz zniszczyć <t color='#B92DE0'>%1</t> (<t color='#B92DE0'>%2</t>), pamiętaj, że to NIE JEST odwracalne...", _name, _textureName],
	[_display, _id, _classname, _texture, _index, _name, _textureName],
	{
		...
		[format ["Zniszczyłeś <t color='#B92DE0'>%1</t> (<t color='#B92DE0'>%2</t>)", _name, _textureName]] call fini_fnc_noty;
	}, {}, false
