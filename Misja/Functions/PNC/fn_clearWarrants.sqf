...
if (isNull _unit) exitWith {
	["Musisz wybrać nakaz, który chcesz usunąć..."] call fini_fnc_noty;
};

[
	(findDisplay getNumber(configFile >> "RscDisplayMission" >> "idd")), "Potwierdzenie", ["Tak", "Nie"],
	format ["Czy na pewno chcesz wyczyścić nakazy %1?...", name _unit], [_unit, _display, _list, _path],
	{	
		...
		[format ["Usunąłeś nakazy<t color='#B92DE0'>%1's</t>", name _unit]] call fini_fnc_noty;
	}, {}, false
