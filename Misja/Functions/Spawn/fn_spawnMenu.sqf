...
if (!(createDialog "DialogSpawn") || { isNil "ULP_ID" }) exitWith {
	["Nie udało się utworzyć okna dialogowego odrodzenia lub identyfikator ULP_ID nie został skonfigurowany, co wskazuje na nieudane zapytanie o dane."] call ULP_fnc_logIt;
