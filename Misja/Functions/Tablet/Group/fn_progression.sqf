...
(_display displayCtrl 23001) ctrlSetStructuredText parseText format["<t align='left'>Grupowy - %1 Progress</t>", ((group player) getVariable ["group_type", "Group"])];
...
(_display displayCtrl 23084) ctrlSetStructuredText parseText format ["<t size='2.5'>Poziom %1<t align='center'>%2/%3</t><t align='right'>Poziom %4</t>",
...

{
	...
	_overlay ctrlSetStructuredText parseText format["<br/><br/><t size='2' align='center'>Wymaga poziomu %1</t>", getNumber (_x >> "level")];
