...
(_display displayCtrl 23001) ctrlSetStructuredText parseText format["<t align='left'>Ekwipunek</t><t align='right'>%1/%2</t>", _carryWeight, _maxWeight];
