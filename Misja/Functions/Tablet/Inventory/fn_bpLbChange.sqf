...
_info ctrlSetStructuredText parsetext format [
	"<br/><br/><img image = '%1' align='center' size='4.5' /><br/><t align = 'center' size = '1.5'>%2</t><br/><t align = 'left' size = '1'><br/>%3<br/><br/>Wymaga stołu: %4<br/><br/>Materiały:<br/><t size='0.8'>%5</t></t>",
	getText(_cfg >> "icon"), 
	getText(_cfg >> "displayName"), 
	getText(_cfg >> "description"), 
	["Nie", "Tak"] select ([getNumber (_cfg >> "workbench")] call ULP_fnc_bool),
