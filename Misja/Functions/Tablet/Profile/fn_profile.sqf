...
_prestigeText ctrlSetStructuredText parseText format["<t size ='1' align='center'>Prestiż: <t size ='1.25'>%1</t><br/></t>", [ULP_Prestige] call ULP_fnc_numberText];

private _levelText = _display displayCtrl 23026;
_levelText ctrlSetStructuredText parseText format["<t size ='1' align='center'>Poziom: <t size ='1.25'>%1</t><br/></t>", [ULP_Level] call ULP_fnc_numberText];

private _repText = _display displayCtrl 23027;
_repText ctrlSetStructuredText parseText format["<t size ='1' align='center'>Reputacja: <t size ='1.25'>%1</t><br/></t>", [ULP_Reputation] call ULP_fnc_numberText];
