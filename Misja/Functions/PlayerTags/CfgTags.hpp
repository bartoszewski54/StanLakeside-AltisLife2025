class CfgTags {
	...
	class Icons {
		...
		class Protection {
			...
			displayName = "Ochrona burmistrza";
		...
		class MedicSenior {
			...
			subtitle = "Zaawansowany ratownik";
