...
if (_type isEqualTo 0) then {
	...
	_personalTitle ctrlSetStructuredText parseText format["Twój ekwipunek <t align='right'>%1/%2</t>", _carryWeight, _maxWeight];
	...
	_containerTitle ctrlSetStructuredText parseText format["Pojemnik <t align='right'>%1/%2</t>", [_container] call ULP_fnc_currentLoad, [_container] call ULP_fnc_maxLoad];
