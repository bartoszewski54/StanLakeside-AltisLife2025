...
if !(isNull _arrester) then {
	[format["Zostałeś skazany na <t color='#B92DE0'>%1</t> minut więzienia przez <t color='#B92DE0'>%2</t>", [_duration, "MM:SS"] call BIS_fnc_secondsToString, name _arrester]] call fini_fnc_noty;
};
