...
if (_group && { !([] call ULP_fnc_isGroup) }) exitWith {
	["Musisz być w grupie, aby uzyskać do niej dostęp!"] call fini_fnc_noty;
	_ctrl lbSetCurSel 0;
...
_balance ctrlSetStructuredText parseText format["<t align='left'>%1</t><t align='right'>%2%3</t><br/><t size='0.9'>Bank<t align='right'>Podatek</t></t>",
