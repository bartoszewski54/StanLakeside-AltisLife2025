class CfgItemsStore {
	...
	class Police {
		...
		class Rifles {
			...
			class arifle_Mk20C_plain_F {
				displayName = "Broń na gumowe kule";
				class textures { class arifle_Mk20C_plain_F {}; };
			};
			class arifle_SDAR_F { condition = "[""Police_Main"", 2] call ULP_fnc_hasAccess"; };
			...
			class arifle_MXM_Black_F {
				condition = "[""Police_Main"", 6] call ULP_fnc_hasAccess";
			...
			class LMG_Mk200_F {
				condition = "[""Police_Main"", 7] call ULP_fnc_hasAccess";
				class textures { class LMG_Mk200_F {}; };
			};
			class LMG_03_F {
				condition = "[""Police_Main"", 5] call ULP_fnc_hasAccess";
				class textures { class LMG_03_F {}; };
			};
			class arifle_AK12_F {
				condition = "[""Police_Main"", 7] call ULP_fnc_hasAccess";
				class textures { class arifle_AK12_F {}; };
			};

		};
		class Pistols {
			class hgun_P07_F {};
			class hgun_ACPC2_F { condition = "[""Police_Main"", 5] call ULP_fnc_hasAccess"; };
		};
		class Attachments {
      ...
      class optic_NVS {};
		...
		class Magazines {
			class 16Rnd_9x21_Mag {
				displayName = "Cartridge do Tasera";
				condition = "[""Police_Main"", 2] call ULP_fnc_hasAccess";
			};
			class launch_RPG32_F {
				displayName = "Alamut RPG-42";
				condition = "[""Police_Main"", 5] call ULP_fnc_hasAccess";
			};
			class RPG32_F {
				displayName = "Pocisk wybuchowy - Alamut";
				condition = "[""Police_Main"", 5] call ULP_fnc_hasAccess";
			};
			...
			class 9Rnd_45ACP_Mag { condition = "[""Police_Main"", 1] call ULP_fnc_hasAccess"; };
			class 50Rnd_570x28_SMG_03 { condition = "[""Police_Main"", 4] call ULP_fnc_hasAccess"; };
			class 30Rnd_556x45_Stanag_Tracer_Red {
				displayName = "Rubber Bullet Mag";
				class textures { class 30Rnd_556x45_Stanag_Tracer_Green {}; };
			};
			class 20Rnd_556x45_UW_mag { condition = "[""Police_Main"", 1] call ULP_fnc_hasAccess"; };
			class 30Rnd_556x45_Stanag { condition = "[""Police_Main"", 3] call ULP_fnc_hasAccess"; };
			class 150Rnd_556x45_Drum_Mag_F { condition = "[""Police_Main"", 6] call ULP_fnc_hasAccess"; };
			class 150Rnd_556x45_Drum_Mag_Tracer_F { condition = "[""Police_Main"", 6] call ULP_fnc_hasAccess"; };
			...
			class 100Rnd_580x42_Mag_F { condition = "[""Police_Main"", 6] call ULP_fnc_hasAccess"; };
			class 100Rnd_580x42_Mag_Tracer_F { condition = "[""Police_Main"", 6] call ULP_fnc_hasAccess"; };
			class 30Rnd_65x39_caseless_green { condition = "[""Police_Main"", 5] call ULP_fnc_hasAccess"; };
			class 30Rnd_65x39_caseless_green_mag_Tracer { condition = "[""Police_Main"", 5] call ULP_fnc_hasAccess"; };
			class 30Rnd_65x39_caseless_msbs_mag { condition = "[""Police_Main"", 4] call ULP_fnc_hasAccess"; };
			class 30Rnd_65x39_caseless_msbs_mag_Tracer { condition = "[""Police_Main"", 4] call ULP_fnc_hasAccess"; };
			...
			class 6Rnd_12Gauge_Slug { condition = "[""Police_Main"", 3] call ULP_fnc_hasAccess"; };
			...
			class 1Rnd_Smoke_Grenade_shell {
				condition = "[""Police_Main"", 2] call ULP_fnc_hasAccess";
				class textures { class 1Rnd_SmokeBlue_Grenade_shell {}; };
			};
		};
		class Items {
			class ItemMap {};
			...
			class ItemWatch {};
			class ItemGPS {};
			class B_UavTerminal { condition = "[""Police_Main"", 8] call ULP_fnc_hasAccess"; };
			class ItemRadio {};
			class Rangefinder {};
	...
	class Rebel {
		...
		class Rifles {
			...
			class arifle_MX_SW_Black_F {};
			class srifle_DMR_06_olive_F {};
			class B_Patrol_Soldier_Marksman_weapon_F {};
			class arifle_AK12_F {};
			//class srifle_DMR_01_DMS_F {};
		};
