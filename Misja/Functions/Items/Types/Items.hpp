...
class HandGrenade_Stone { price = 3500;};
...
class SmokeShell {
	...
	class Textures {
        ...
        class SmokeShellBlue : SmokeShell { displayName = "Gaz pieprzowy"; condition = "[""Police_Main"", 1] call ULP_fnc_hasAccess";};
