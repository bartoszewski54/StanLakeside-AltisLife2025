...
// RPG ammo
class RPG7_F : RepMagazine { price = 750000 };
class launch_RPG7_F : RepMagazine { price = 1500000 };
//rebelka dodane nowe 25.01
...
class 1Rnd_Smoke_Grenade_shell : RepMagazine {
	...
	class Textures {
		...
		class 1Rnd_SmokeBlue_Grenade_shell : 1Rnd_Smoke_Grenade_shell { displayName = "Gaz pieprzowy"; condition = "[""Police_Main"", 11] call ULP_fnc_hasAccess";   };
