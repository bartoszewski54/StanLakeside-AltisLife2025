...
_this params [
	...
	["_impound", false, [true]],
	["_condition", "true", [""]],
	["_title", "<t color='#B92DE0'>[CYWILNY]</t>", [""]]
];
...
if (_includeStore) then {
	_trader addAction [format["%1 Schowaj Pojazd", _title], { [(_this select 0), (_this select 3)] call ULP_fnc_storeVehicle }, _types, 1.5, true, true, "", _condition, 3];
};