...
_trader addAction ["<t color='#B528D0'>[GOV]</t> Stacja wyborcza", { _this call ULP_fnc_openPollingStation },
	nil, 1.5, true, true, "", "missionNamespace getVariable [""ULP_SRV_Setting_Election"", false]", 5];

_trader addAction ["<t color='#B528D0'>[GOV]</t> Fałszuj - Stacja wyborcza ", { _this call ULP_fnc_rigPollingStation },
...
_trader addAction ["<t color='#B528D0'>[GOV]</t> Zaciąg wyborczy", { [] call ULP_fnc_enlist },
	nil, 1.5, true, true, "", "!(missionNamespace getVariable [""ULP_SRV_Setting_Election"", false])", 5];