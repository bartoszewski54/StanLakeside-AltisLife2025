...
//if !(incapacitatedState player == "UNCONSCIOUS") exitWith {[_unit, _killer] call ULP_fnc_onIncapacitated;};
...
"WaitToRespawn" cutText ["<t color='#ffffff' font='PuristaLight' size='2px'>UMARŁEŚ</t>", "BLACK", -1, false, true];
