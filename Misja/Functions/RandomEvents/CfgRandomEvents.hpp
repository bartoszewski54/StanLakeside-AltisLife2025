class CfgRandomEvents {
	...
	class Airdrop {
		...
		class Events {
			class OnWarning { code = "_this params [[""_message"", """", [""""]]]; [_message] call fini_fnc_noty;"; };
			class OnSpawn { code = "_this call ULP_fnc_onAirdropSpawn;"; };
			class OnClaimed { code = "_this params [[""_message"", """", [""""]], [""_reward"", -1, [0]]]; [_reward, false, ""Popup Cartel""] call ULP_fnc_addMoney; [100, ""Captured Popup Cartel""] call ULP_fnc_addXP; [_message] call fini_fnc_noty;"; };
		};
	...
	class PopupCartel : Airdrop {
		...
		class Events : Events {
			...
			class OnClaimed { code = "_this params [[""_message"", """", [""""]], [""_reward"", -1, [0]]]; [_reward, false, ""Popup Cartel""] call ULP_fnc_addMoney; if (_reward > 0) then { [100, ""Captured Popup Cartel""] call ULP_fnc_addXP; }; [_message] call fini_fnc_noty;"; };
		};
		class ServerFunctions : ServerFunctions {
