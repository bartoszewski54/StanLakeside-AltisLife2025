...
sleep 2.5;
[1, "NACIŚNIJ [SPACJA] ABY KONTYNUOWAĆ (ODCISZ MUZYKĘ W USTAWIENIACH)"] call mav_introcam_fnc_updateCinematicStatus;
waitUntil {mav_introcam_continue};
CAU_xChat_messageFeedShown = true;
...
if (isNil "ULP_UCLevels") then {
	...
	[
		(findDisplay getNumber(configFile >> "RscDisplayMission" >> "idd")), "Wybór roli", ["UC", "Cywil"],
		"Jesteś w jednostce undercover, czy chcesz wejść na cywila czy policję?", [_cop, _uc],
		{	
