...
class CfgRemoteExec {
    class Commands {
        ...
        class switchMove {};
        class addMPEventHandler {}; // Dodanie tej linii może odblokować komendę
        class removeMPEventHandler {}; // Dodanie tej linii może odblokować komendę
    };
    ...
    class Functions {
		...
		class ah_playerload {allowedTargets=2;};
		class ah_keycheck {allowedTargets=2;};
		class ah_loginterface {allowedTargets=2;};
		class setunitloadout {allowedTargets=1;}
        ...
        class BIS_fnc_effectKilled { allowedTargets = 2; }; // 2 = tylko serwer
        class BIS_fnc_effectKilledAirDestruction { allowedTargets = 2; };
        class fini_fnc_noty {
            allowedTargets = 0; // 0 = wszyscy (klient, serwer)
        };
        ...
        class bis_fnc_debugconsoleexec {}; //mozliwy fix na tych pedalow
    };
};